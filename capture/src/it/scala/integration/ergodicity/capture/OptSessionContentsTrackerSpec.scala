...
import com.ergodicity.capture.{OptSessionContentsTracker, MongoLocal, MarketCaptureRepository}
...
class OptSessionContentsTrackerSpec extends WordSpec {
  ...
  val repository = new MarketCaptureRepository(MongoLocal("OptSessionContentsTrackerSpec")) with OptSessionContentsTracker
