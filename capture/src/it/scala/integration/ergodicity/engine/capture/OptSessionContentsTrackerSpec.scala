...
import com.ergodicity.engine.capture.{OptSessionContentsTracker, MongoDefault, MarketCaptureRepository}
...
class OptSessionContentsTrackerSpec extends WordSpec {
  ...
  val repository = new MarketCaptureRepository(MongoDefault("OptSessionContentsTrackerSpec")) with OptSessionContentsTracker
  ...
  "MarketCaptureRepository with OptSessionContentsTracker" must {
